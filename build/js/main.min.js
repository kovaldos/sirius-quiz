...
/* harmony import */ var _modules_quiz__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/quiz */ "./js/modules/quiz.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_quiz__WEBPACK_IMPORTED_MODULE_4__["initQuiz"])();
  });
}); // ---------------------------------
...
var quizFormSuccessCallback = function quizFormSuccessCallback(e) {
  e.preventDefault(); // В данном колбеке бэкендер будет писать запрос на отправку формы на сервер и обрабатывать возможные ошибки при отправке

  var form01 = document.querySelector('.quiz__form--01');
  var form02 = document.querySelector('.quiz__form--02');
  var form03 = document.querySelector('.quiz__form--03');
  var form04 = document.querySelector('.quiz__form--04');
  var form05 = document.querySelector('.quiz__form--05');
  var resultBlock = document.querySelector('.quiz__result');
  var navStripes = document.querySelectorAll('.quiz__nav-link');
  var formData = new FormData(e.target);
  var DATA = [];

  var switchScreen = function switchScreen(screen1, screen2, index1, index2) {
  ...
  DATA.push(formData); // Список пар ключ/значение
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      console.log("".concat(name, " = ").concat(value)); // key1=value1, потом key2=value2
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
var quizFormErrorCallback = function quizFormErrorCallback(e) {
...
/*!****************************!*\
  !*** ./js/modules/quiz.js ***!
  \****************************/
/*! exports provided: initQuiz */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initQuiz", function() { return initQuiz; });
/* eslint-disable no-console */
//  Кнопки плюс и минус в форм-квизе -- Начало --
var initQuiz = function initQuiz() {
  var quizBlock = document.querySelector('.quiz');
  var counterWarning = quizBlock.querySelector('.quiz__form-warning');
  var input = quizBlock.querySelector('.quiz__form-input input');
  var counter = input.value;

  var initCounter = function initCounter(btn) {
